...
//-----------------------------------------------------
function themo_start_flex_slider(
  flex_selector,
  themo_autoplay,
  themo_flex_animation,
  themo_flex_easing,
  themo_flex_animationloop,
  themo_flex_smoothheight,
  themo_flex_slideshowspeed,
  themo_flex_animationspeed,
  themo_flex_randomize,
  themo_flex_pauseonhover,
  themo_flex_touch,
  themo_flex_directionnav,
  themo_flex_controlNav
) {
...
jQuery(function ($) {
  ...
  function themo_init_isotope() {
    ...
    $.fn.equalizeHeights = function () {
      ...
      return this.height(
        // set the height of element <div> element to...
        Math.max.apply(
          // the largest value in...
          this,
          two.get() // the array of height values
        )
      ); // ...and finally, return the original jQuery object to enable chaining
    };

    // Room Grid / Portfolio
    var $container = $(".th-portfolio-row").not(
      ".elementor-element-edit-mode .th-portfolio-row"
    );
...
jQuery(document).ready(function ($) {
  ...
  if (
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/themo-image-carousel-timeline.default",
      function ($scope) {
