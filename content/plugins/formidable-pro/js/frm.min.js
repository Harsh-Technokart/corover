...
function frmFrontFormJS() {
  ...
  function maybeShowLabel() {
    var $field = jQuery(this),
      ...
      val = $field.val();
    if (val !== null && val.length > 0) $label.addClass("frm_visible");
    ...
    if (fields.length)
      for (n = 0, nl = fields.length; n < nl; n++) {
        ...
        if (value !== "")
          ...
          else if (field.type === "url") errors = checkUrlField(field, errors);
  ...
  function validateField(fieldId, field) {
    ...
    if (errors.length < 1)
      if (field.type === "email") errors = checkEmailField(field, errors);
      else if (field.type === "password")
        errors = checkPasswordField(field, errors);
      else if (field.type === "number")
        errors = checkNumberField(field, errors);
  ...
  function checkRequiredField(field, errors) {
    ...
    if (field.type === "hidden" && fileID === null) return errors;
    if (field.type === "checkbox" || field.type === "radio") {
      ...
      if (fieldClasses.indexOf("frm_pos_none") !== -1) return errors;
    ...
    jQuery.ajax({
      ...
      success: function (response) {
        ...
        if (typeof response.redirect !== "undefined") {
          ...
          else jQuery(object).prepend(response.error_message);
        } else {
  ...
  function addFieldError($fieldCont, key, jsErrors) {
    ...
    if ($fieldCont.length && $fieldCont.is(":visible")) {
      ...
      if (typeof frmThemeOverride_frmPlaceError === "function")
        ...
        $fieldCont.append(
          '<div class="frm_error" id="' + id + '">' + jsErrors[key] + "</div>"
        );
  ...
  return {
    ...
    fieldValueChanged: function (e) {
      ...
      if (e.selfTriggered !== true) maybeValidateChange(fieldId, this);
    },
  ...
  function clearValueForInputs(inputs, required) {
    ...
    for (var i = 0, l = inputs.length; i < l; i++) {
      ...
      if (inputs[i].type === "radio" || inputs[i].type === "checkbox")
        ...
        if (blankSelect || inputs[i].selectedIndex === -1) valueChanged = false;
        else inputs[i].selectedIndex = -1;
